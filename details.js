const topics = {
  'egipto-escritura': {
    ...
    points: ['Jeroglíficos: signos sagrados usados en monumentos.', 'Papiro: soporte flexible parecido al papel.', 'Piedra de Rosetta: clave para descifrar los jeroglíficos.'], resource: 'https://www.youtube.com/watch?v=WuzkJVhfCLo'
  },
  'egipto-ingenieria': {
    ...
    points: ['Rampas para elevar bloques pesados.', 'Canales para aprovechar las crecidas del Nilo.', 'Pirámides, templos y obeliscos como arquitectura simbólica.'], resource: 'https://www.youtube.com/watch?v=WuzkJVhfCLo'
  },
  'egipto-medicina': {
    ...
    points: ['Papiro de Smith: lesiones, diagnósticos y tratamientos.', 'Papiro de Ebers: recetas y tratamientos médicos.', 'Prótesis y herramientas quirúrgicas para atender lesiones.'], resource: 'https://www.youtube.com/watch?v=NiJcyn6pV04'
  },
  'grecia-democracia': {
    ...
    points: ['La Asamblea debatía y votaba las decisiones.', 'El ágora era un espacio de intercambio y discusión.', 'La ciudadanía estaba limitada a una parte de la población.'], resource: 'https://www.youtube.com/watch?v=DWr_F-C-Vo4Y'
  },
  'grecia-teatro': {
    ...
    points: ['Tragedia: conflictos sobre destino, poder y responsabilidad.', 'Comedia: crítica social mediante humor y sátira.', 'El coro guiaba la historia y comentaba la acción.'], resource: 'https://www.youtube.com/watch?v=9LMlD7L4Vdk'
  },
  'grecia-arte': {
    ...
    points: ['Columnas dóricas, jónicas y corintias.', 'Esculturas que exploraban proporción y movimiento.', 'Juegos atléticos vinculados a festividades religiosas.'], resource: 'https://www.youtube.com/watch?v=PUZgGEL9Mwc'
  },
  'mesopotamia-escritura': {
    ...
    points: ['Tablillas de arcilla como soporte resistente.', 'Signos en forma de cuña hechos con una caña.', 'Registros de comercio, impuestos, leyes y relatos.'], resource: 'https://www.youtube.com/results?search_query=escritura+cuneiforme+mesopotamia'
  },
  'mesopotamia-leyes': {
    ...
    points: ['Regulaba comercio, trabajo, familia y propiedad.', 'Las penas dependían de la situación social.', 'La estela hacía las normas visibles y permanentes.'], resource: 'https://www.youtube.com/results?search_query=codigo+de+hammurabi+mesopotamia'
  },
  'mesopotamia-astronomia': {
    ...
    points: ['Calendarios ligados a los ciclos de la Luna.', 'Registros sistemáticos de estrellas y planetas.', 'Sistema sexagesimal: base de nuestras horas y minutos.'], resource: 'https://www.youtube.com/results?search_query=astronomia+mesopotamia+antigua'
  }
};
...
content.innerHTML = `
  ...
  <div class="detail-layout">
    <div class="detail-copy"><h2>¿Qué hacían?</h2><p>${topic.body}</p><a class="detail-resource" href="${topic.resource}" target="_blank" rel="noopener noreferrer">▶ Ver recurso audiovisual ↗</a></div>
